...
{\noindent}	 \rule[-10pt]{17.5cm}{0.5em}\\
\section{基础}
\input{body/nlp/basic}

\section{经典算法}
\input{body/nlp/classic}
...
{\noindent}	 \rule[-10pt]{17.5cm}{0.5em}\\
\section{基本概念}
\input{body/recsys/basic}

\section{经典算法}
\input{body/recsys/classic}

\section{用户兴趣建模}
\input{body/recsys/interest}

\section{多任务学习}
\input{body/recsys/mtl}
...
{\noindent}	 \rule[-10pt]{17.5cm}{0.5em}\\
\section{Basic}
\input{body/algorithms/basic}
\section{Search}
\input{body/algorithms/search}
...
\section{C++}
\input{body/coding/cpp}

\section{Python}
\input{body/coding/python}

\section{Tensorflow}
\input{body/coding/tensorflow}

\section{Pytorch}
\input{body/coding/pytorch}

\section{Shell}
\input{body/coding/shell}

\section{ML/DL错误集锦}
\input{body/coding/lessons}
%\section{IDEAS}
%\subsection{Ideas01}
%\input{body/Ideas/chap01}
\section{\LaTeX}
\input{body/latex}
...
\section{HDFS}
\input{body/bigdata/hdfs}

\section{MapReduce}
\input{body/bigdata/mapreduce}

\section{Spark}
\input{body/bigdata/spark}
